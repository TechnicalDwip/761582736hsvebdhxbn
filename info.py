...
BOT_TOKEN = environ.get('BOT_TOKEN', "6226398171:AAGKSiO4AFL0q9W0UG0TSo-Vs0EZ_qTaDEs") #if you are going to bot token here make sure your repo is private..
...
PICS = (environ.get('PICS', 'https://graph.org/file/d777c2add00f1f6e67d0c.png')).split() #use a gif video 🫠
NOR_IMG = environ.get("NOR_IMG", "https://te.legra.ph/file/a27dc8fe434e6b846b0f8.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/e1f3c25b5baf2a564919f.png")
DONATE = environ.get("DONATE", "https://telegra.ph/file/9d90a18625b9770a74081.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6812448168 1782834874').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001996043379').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6812448168 1782834874').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001774060800')
auth_grp = environ.get('AUTH_GROUP', '-1001609550110')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001540617431')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001685262903')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jiofibretv55:jiofibretv55@cluster0.ppnlg2q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Shinchan")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/swifthornrequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/swifthorncinema')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/royaldwip')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', '😼 Piracy Is Crime 👀')

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002087721784'))
VERIFY_REQ_CHNL = int(environ.get('VERIFY_REQ_CHNL', '-1002087721784'))
NEW_USER_LOG = int(environ.get('NEW_USER_LOG', '-1002087721784'))
BIN_CHNL = int(environ.get('BIN_CHNL', '-1002087721784'))
